      ...
      <section className="w-full py-20">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="bg-paper-soft rounded-xl p-6 mb-8 border border-cyan-500/20">
              <div className="flex items-center gap-3 justify-center mb-1">
                <span className="text-ink-soft text-sm">Une confirmation a aussi été envoyée à</span>
              </div>
              <div className="text-cyan-700 font-mono font-semibold">{email}</div>
            </div>

            <div className="space-y-3 mb-8 text-left bg-paper-soft rounded-xl p-6">
              <h3 className="font-bold text-ink mb-3">Prochaines étapes :</h3>
              <div className="flex gap-3 items-start">
                ...
                <p className="text-sm text-ink-soft">Ouvrez le fichier téléchargé (<code>Mouhassib-Setup.exe</code>) dans votre dossier Téléchargements.</p>
              </div>
              <div className="flex gap-3 items-start">
                ...
                <p className="text-sm text-ink-soft">Autorisez l'installation si Windows affiche un avertissement (SmartScreen).</p>
              </div>
              <div className="flex gap-3 items-start">
                ...
                <p className="text-sm text-ink-soft">Installez Mouhassib sur votre PC Windows et lancez votre essai gratuit de 30 jours.</p>
              </div>
            </div>

            <p className="text-xs text-ink-faint mb-8">
              Le téléchargement n'a pas démarré ?<br />
              Utilisez le bouton ci-dessus, ou <Link to="/contact" className="text-cyan-700 underline">contactez-nous</Link>.
            </p>
